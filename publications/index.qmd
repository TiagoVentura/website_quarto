...
[Replication Materials](https://github.com/TiagoVentura/truth_be_told_NMS){target="_blank"}
...
[Replication Materials](https://github.com/TiagoVentura/Network_Activated_Frames_JoC){target="_blank"}
...
::: {.pub-authors}
[Fabiano Santos](http://www.iesp.uerj.br/en/docentes/fabiano-guilherme-mendes-santos/){target="_blank"}, Talita Tanscheit, Tiago Ventura
:::
::: {.pub-venue}
Dados, 2020
:::
::: {.pub-links}
[PDF](../files/STV_PT_E_OP.pdf){target="_blank"}
[Cite](../files/bib/santos2020pt.bib)
:::
<details class="pub-abstract-toggle"><summary>Abstract</summary>
Examines how internal dynamics of the Brazilian Workers' Party (PT) influences the adoption of participatory public policies by municipal administrations. Analyzes how party internal factions interfere with participatory budget adoption. Hypothesis: adoption becomes more likely when left-wing factions have a stronger presence. Tests with logistic regression models (2005-2012).
</details>
:::
